...
TARGET_KERNEL_CONFIG := lineage_sltecan_defconfig
...
# Filesystem
TARGET_FS_CONFIG_GEN := device/samsung/sltecan/config.fs

# HIDL
DEVICE_MANIFEST_FILE += device/samsung/sltecan/manifest.xml

# Legacy BLOB Support
TARGET_NEEDS_PLATFORM_TEXT_RELOCATIONS := true

# LineageHW
BOARD_HARDWARE_CLASS += device/samsung/sltecan/lineagehw
...
TARGET_RECOVERY_FSTAB := device/samsung/sltecan/rootdir/etc/fstab.full
...
# SELinux
include device/samsung/sltecan/sepolicy/sepolicy.mk
